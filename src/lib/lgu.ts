...
function withFallback(row: {
  ...
  bfp_contact_email: string | null; bfp_contact_phone: string | null;
  ...
  return {
    ...
    bfpContactEmail: row.bfp_contact_email,
    bfpContactPhone: row.bfp_contact_phone,
  };
}
